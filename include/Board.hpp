...
class Board : public UIComponent
{
  public:
    ...
    void drawPossibleMove(sf::RenderWindow &window, const sf::Vector2i position,
    ...
    sf::Vector2i getCellFromMousePos(const sf::RenderWindow &window,
    ...
    std::vector<std::pair<sf::Vector2i, bool>> getValidMoves(
        Piece &piece) const;
    bool isValidMove(Piece &piece, sf::Vector2i newPosition) const;
  ...
  private:
    ...
    std::vector<std::pair<sf::Vector2i, bool>> possibleMoves;
